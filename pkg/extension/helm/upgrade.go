...
func Upgrade(restConfig *rest.Config, releaseName, chartName, namespace, version string, kvs map[string]string) (*release.Release, error) {
	client := action.NewUpgrade(actionConfiguration(restConfig, namespace))
