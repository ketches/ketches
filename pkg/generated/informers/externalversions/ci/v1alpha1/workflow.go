...
import (
	...
	v1alpha1 "github.com/ketches/ketches/pkg/generated/listers/ci/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CiV1alpha1().Workflows(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CiV1alpha1().Workflows(namespace).Watch(context.TODO(), options)
			},
		},
		&civ1alpha1.Workflow{},
		resyncPeriod,
...
func (f *workflowInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&civ1alpha1.Workflow{}, f.defaultInformer)
}
