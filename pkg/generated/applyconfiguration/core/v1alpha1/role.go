...
type RoleApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	...
	Status                           *corev1alpha1.RoleStatus    `json:"status,omitempty"`
}

// Role constructs an declarative configuration of the Role type for use with
// apply.
func Role(name string) *RoleApplyConfiguration {
...
func (b *RoleApplyConfiguration) WithStatus(value corev1alpha1.RoleStatus) *RoleApplyConfiguration {
	b.Status = &value
	return b
}
