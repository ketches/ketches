...
func (b *WorkflowStatusApplyConfiguration) WithPhase(value string) *WorkflowStatusApplyConfiguration {
	b.Phase = &value
	return b
}
...
func (b *WorkflowStatusApplyConfiguration) WithConditions(values ...*BuildConditionApplyConfiguration) *WorkflowStatusApplyConfiguration {
	for i := range values {
		if values[i] == nil {
