...
// CoreV1alpha1Client is used to interact with features provided by the core.ketches.io group.
...
func (c *CoreV1alpha1Client) ApplicationGroups(namespace string) ApplicationGroupInterface {
	return newApplicationGroups(c, namespace)
}

func (c *CoreV1alpha1Client) Audits(namespace string) AuditInterface {
	return newAudits(c, namespace)
}

func (c *CoreV1alpha1Client) Clusters() ClusterInterface {
...
func (c *CoreV1alpha1Client) Roles() RoleInterface {
	return newRoles(c)
}

func (c *CoreV1alpha1Client) Spaces() SpaceInterface {
	return newSpaces(c)
}

func (c *CoreV1alpha1Client) Users() UserInterface {
	return newUsers(c)
}
