...
type Env struct {
	...
	ProjectID        string `json:"projectID" gorm:"not null;uniqueIndex:idx_projectID_slug,idx_projectID_name;index;size:36"` // Project UUID this environment belongs to
	...
	ClusterID        string `json:"clusterID" gorm:"not null;index;size:36"`                                                   // Cluster UUID where this environment is deployed
