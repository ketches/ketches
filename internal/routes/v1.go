	...
	v1.Use(middlewares.OperationLog())
	{
		...
		authorized.Use(middlewares.Auth(), middlewares.CSRF())
		{
			...
			recycleBin := authorized.Group("/recycle-bin")
			{
				...
				recycleBin.POST("/apps/restore", middlewares.RequireRecycleBinOwner("apps"), handlers.RestoreApps)
				recycleBin.POST("/apps/permanently-delete", middlewares.RequireRecycleBinOwner("apps"), handlers.PermanentlyDeleteApps)
				recycleBin.GET("/envs", handlers.ListRecycleBinEnvs)
				recycleBin.POST("/envs/restore", middlewares.RequireRecycleBinOwner("envs"), handlers.RestoreEnvs)
				recycleBin.POST("/envs/permanently-delete", middlewares.RequireRecycleBinOwner("envs"), handlers.PermanentlyDeleteEnvs)
				...
				recycleBin.POST("/projects/restore", middlewares.RequireRecycleBinOwner("projects"), handlers.RestoreProjects)
				recycleBin.POST("/projects/permanently-delete", middlewares.RequireRecycleBinOwner("projects"), handlers.PermanentlyDeleteProjects)
				...
				recycleBin.POST("/code-repositories/restore", middlewares.RequireRecycleBinOwner("code-repositories"), handlers.RestoreCodeRepositories)
